...
templates['items-table.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <tr data-id=\""
    ...
    + "</td>\n            <td>\n                <button class=\"table-btn btn-edit-item\" data-action=\"edit\" data-id=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"itemId") || (depth0 != null ? lookupProperty(depth0,"itemId") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"itemId","hash":{},"data":data,"loc":{"start":{"line":21,"column":84},"end":{"line":21,"column":94}}}) : helper)))
    + "\">\n                    <i class=\"fas fa-edit\"></i>\n                </button>\n                <button class=\"table-btn btn-delete-item\" data-action=\"delete\" data-id=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"itemId") || (depth0 != null ? lookupProperty(depth0,"itemId") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"itemId","hash":{},"data":data,"loc":{"start":{"line":24,"column":88},"end":{"line":24,"column":98}}}) : helper)))
  ...
  return "<table class=\"table table-bordered table-striped data-table\">\n    <thead>\n        <tr>\n            <th>Description</th>\n            <th>Quantity</th>\n            <th>Expiration Date</th>\n            <th>Bin</th>\n            <th>Bin Location</th>\n            <th></th>\n        </tr>\n    </thead>\n    <tbody>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":13,"column":8},"end":{"line":29,"column":17}}})) != null ? stack1 : "")
    + "    </tbody>\n</table>";
},"useData":true});
})();